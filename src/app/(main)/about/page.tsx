...
export default function AboutPage() {
  return (
    <main className="flex-grow flex flex-col gap-12 py-16 lg:py-24 px-8 min-h-screen">
      <div className="w-full max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert">
          <p className="text-xl text-muted-foreground mb-12">
            ...
            is the production-ready auth foundation that lives in your codebase,
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                Comprehensive 2FA with authenticator app, SMS, and backup codes
              </li>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground">
              ...
              systems over and over again. By April, I was dreaming of having a
              solid auth starter I could just clone for new projects. But it
              ...
              four months were intense. January 2025 hit hard - bugs everywhere,
              missing features, and moments where giving up felt tempting. But
              there was no choice but to push through. By late January, the bugs
              were getting squashed, features were falling into place, and what
              started as frustration was becoming something developers could
              actually build on.
            </p>
          </section>
        </div>
