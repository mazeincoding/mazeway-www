  ...
  return (
    <main className="flex-grow flex flex-col gap-12 py-16 lg:py-24 px-8 min-h-screen">
      <div className="w-full max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold tracking-tight mb-6">Terms of Use</h1>
        <div className="prose prose-lg dark:prose-invert">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mt-4">
              Just like Shadcn UI, the code lives in your project - you own it,
              you control it.
            </p>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4">Your Implementation</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground">
              Found a bug? Got an improvement? Contributions are welcome! Check
              out our GitHub repository for contribution guidelines. By
              contributing, you agree to license your code under the same terms
              as Mazeway.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground">
              Need help with implementation or have questions? Check the docs or{" "}
